...
const OrderPageContent = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "OrderPageContent.useEffect": ()=>{
            if (!productId) return;
            setLoading(true);
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchProductDetail"])(productId.toString()).then({
...
_s(OrderPageContent, "OolGlEWmBoy1QIVn6geLXPQIHZQ=", false, function() {
    return [
