...
"[project]/src/app/supplier/[id]/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
        ...
        "SupplierPage.useEffect": ()=>{
            ...
            Promise.all([
                ...
                "SupplierPage.useEffect": (param)=>{
                    let [sup, prods, revs] = param;
                    setSupplier(sup);
                    setProducts(prods.filter({
                        "SupplierPage.useEffect": (p)=>p.supplierId === id
                    }["SupplierPage.useEffect"]));
                    setReviews(revs);
                    setLoading(false);
                }
            }["SupplierPage.useEffect"]).catch({
                "SupplierPage.useEffect": (err)=>{
...
_s(SupplierPage, "KB05gFui3J1UeAZ+ymXcRG5VVBs=", false, function() {
    return [
...
//# sourceMappingURL=src_8e587bc3._.js.map