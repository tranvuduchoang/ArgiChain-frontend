...
"[project]/src/hooks/useNetworkCurrency.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const useNetworkCurrency = ()=>{
    _s();
    const { isConnected, account } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$WalletContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useWallet"])();
    const [currency, setCurrency] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('tBNB'); // Default fallback
    const [networkName, setNetworkName] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('BSC Testnet');
    const [isLoading, setIsLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useNetworkCurrency.useEffect": ()=>{
            const detectNetwork = {
                "useNetworkCurrency.useEffect.detectNetwork": async ()=>{
                    // Check if we're on client side and ethereum is available
                    if ("object" === 'undefined' || !window.ethereum || !isConnected) {
                        setCurrency('tBNB');
            ...
            }["useNetworkCurrency.useEffect.detectNetwork"];
            detectNetwork();
            // Listen for network changes
            const handleNetworkChange = {
                "useNetworkCurrency.useEffect.handleNetworkChange": ()=>{
                    detectNetwork();
                }
            }["useNetworkCurrency.useEffect.handleNetworkChange"];
...
_s(useNetworkCurrency, "njRk9vnluQZ1xkKgbvej9Bi2zr8=", false, function() {
    return [
...
"[project]/src/components/NetworkInfo.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
;
;
const NetworkInfo = (param)=>{
    let { className = '' } = param;
    _s();
    const { currency, networkName, isLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useNetworkCurrency$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useNetworkCurrency"])();
    if (isLoading) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: "flex items-center space-x-2 text-sm text-gray-500 ".concat(className),
            children: [
...
_s(NetworkInfo, "ubwzWXZ1shPFSab1TGXJ8rmmHJg=", false, function() {
    return [
...
var _c;
__turbopack_context__.k.register(_c, "NetworkInfo");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$NetworkInfo$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/NetworkInfo.tsx [app-client] (ecmascript)");
...
const Header = ()=>{
    ...
    const { currency, networkName } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useNetworkCurrency$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useNetworkCurrency"])();
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$NetworkInfo$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
...
_s(Header, "zWyim3Tjd9ZBpu1y2OJ8IV0U+7A=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$WalletContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useWallet"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useTranslation$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTranslation"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useNetworkCurrency$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useNetworkCurrency"]
...
//# sourceMappingURL=src_18e58a6a._.js.map