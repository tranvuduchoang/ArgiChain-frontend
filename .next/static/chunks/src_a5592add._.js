...
"[project]/src/utils/autoListing.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function createAutoListing(tokenId, price, quantity) {
    let expiryDays = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : 30, userAddress = arguments.length > 4 ? arguments[4] : void 0;
    try {
        ...
        const nftContractForApproval = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ethers$2f$lib$2e$esm$2f$ethers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__ethers$3e$__["ethers"].Contract(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$blockchain$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BLOCKCHAIN_CONFIG"].NFT_ADDRESS, NFT_ABI, signer);
        // Step 1: Approve marketplace to transfer NFTs
        console.log('🔐 Approving marketplace for NFT transfers...');
        const approveTx = await nftContractForApproval.setApprovalForAll(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$blockchain$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BLOCKCHAIN_CONFIG"].MARKETPLACE_ADDRESS, true);
        ...
        const nftContractForBalance = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ethers$2f$lib$2e$esm$2f$ethers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__ethers$3e$__["ethers"].Contract(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$blockchain$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BLOCKCHAIN_CONFIG"].NFT_ADDRESS, [
            "function balanceOf(address account, uint256 id) external view returns (uint256)"
        ], provider);
        ...
        if (nftBalance < BigInt(quantity)) {
            throw new Error("Insufficient NFT balance. You have ".concat(nftBalance.toString(), " NFTs, trying to list ").concat(quantity));
        }
        // Step 3: Create listing
        console.log('📝 Creating listing...');
        const priceInWei = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ethers$2f$lib$2e$esm$2f$ethers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__ethers$3e$__["ethers"].parseEther(price);
        ...
        const event = receipt.logs.find((log)=>{
            try {
                ...
                return (parsed === null || parsed === void 0 ? void 0 : parsed.name) === 'ProductListed';
            } catch (e) {
                return false;
            }
        });
        ...
        const listingId = Number(parsedEvent === null || parsedEvent === void 0 ? void 0 : parsedEvent.args[0]);
        console.log('🎉 Listing created successfully!');
        console.log('Listing ID:', listingId);
        console.log('Token ID:', parsedEvent === null || parsedEvent === void 0 ? void 0 : parsedEvent.args[1].toString());
        console.log('Price:', __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ethers$2f$lib$2e$esm$2f$ethers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__ethers$3e$__["ethers"].formatEther(parsedEvent === null || parsedEvent === void 0 ? void 0 : parsedEvent.args[3]), 'AGRI');
        console.log('Quantity:', parsedEvent === null || parsedEvent === void 0 ? void 0 : parsedEvent.args[4].toString());
        console.log('Expiry:', new Date(Number(parsedEvent === null || parsedEvent === void 0 ? void 0 : parsedEvent.args[5]) * 1000).toISOString());
        return {
            listingId,
...
async function isMarketplaceApproved(userAddress) {
    try {
        ...
        const isApproved = await nftContract.isApprovedForAll(userAddress, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$blockchain$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BLOCKCHAIN_CONFIG"].MARKETPLACE_ADDRESS);
        return isApproved;
    } catch (error) {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$autoListing$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/utils/autoListing.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ethers$2f$lib$2e$esm$2f$ethers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__ethers$3e$__ = __turbopack_context__.i("[project]/node_modules/ethers/lib.esm/ethers.js [app-client] (ecmascript) <export * as ethers>");
;
...
const MintNFTPageContent = ()=>{
    ...
    const handleMintNFT = async (e)=>{
        ...
        try {
            ...
            try {
                const mintReceipt = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$blockchain$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["waitForTransaction"])(transactionHash, 1);
                // Create NFT contract instance to parse events
                const provider = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ethers$2f$lib$2e$esm$2f$ethers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__ethers$3e$__["ethers"].BrowserProvider(window.ethereum);
                const nftContract = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ethers$2f$lib$2e$esm$2f$ethers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__ethers$3e$__["ethers"].Contract(contractAddress, [
                    "event ProductNFTMinted(uint256 indexed tokenId, address indexed supplier, uint256 amount, string productName, string metadata)",
                ...
                const mintEvent = mintReceipt.logs.find((log)=>{
                    try {
                        ...
                        return (parsed === null || parsed === void 0 ? void 0 : parsed.name) === 'ProductNFTMinted';
                    } catch (e) {
                        return false;
                    }
                });
                if (mintEvent) {
                    ...
                    actualTokenId = Number(parsedEvent === null || parsedEvent === void 0 ? void 0 : parsedEvent.args[0]); // tokenId is the first argument
            ...
            if (mintData.autoList && mintData.listPrice) {
                try {
                    ...
                    const listingResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$autoListing$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createAutoListing"])(confirmTokenId, mintData.listPrice, mintData.listQuantity, mintData.expiryDays, account);
                    setSuccess("Hoàn thành! NFT đã được mint và listing đã được tạo tự động. \n            Mint hash: ".concat(finalTxHash, "\n            Listing ID: ").concat(listingResult.listingId, "\n            Listing hash: ").concat(listingResult.transactionHash));
                } catch (listingError) {
                    console.error('Error creating auto listing:', listingError);
                    setSuccess("Mint NFT thành công! Tuy nhiên, có lỗi khi tạo listing tự động: ".concat(listingError instanceof Error ? listingError.message : 'Unknown error'));
                }
            } else {
                setSuccess("Mint NFT thành công! Transaction hash: ".concat(finalTxHash));
            }
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                ...
                                                mintData.autoList && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(MintNFTPageContent, "3Z5DAXvGewvZVpThh5Q2DCe98hQ=", false, function() {
    return [
...
//# sourceMappingURL=src_a5592add._.js.map