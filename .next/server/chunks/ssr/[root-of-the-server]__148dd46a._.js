    ...
    const loadDashboardData = async ()=>{
        try {
            ...
            const [supplierData, productsData, listingsData] = await Promise.all([
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetchSupplierDetail"])(supplierId),
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetchProducts"])(),
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetchMarketplaceListings"])()
            ]);
            const supplierProducts = productsData.filter((p)=>p.supplier?.id === supplierId);
            const activeListings = listingsData.filter((l)=>l.supplierId === supplierId);
            const mintedProducts = supplierProducts.filter((p)=>p.mintTxHash).length;
            const totalRevenue = supplierProducts.reduce((sum, p)=>{
                return sum + parseFloat(p.pricePerUnit || '0') * (p.totalSupply - p.availableSupply);
            }, 0);
            const availableInventory = supplierProducts.reduce((sum, p)=>{
                return sum + (p.availableSupply || 0);
            }, 0);
            setStats({
                totalProducts: supplierProducts.length,
                activeListings: activeListings.length,
                totalSales: supplierProducts.reduce((sum, p)=>sum + (p.totalSupply - p.availableSupply), 0),
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    ...
                                                    product.mintTxHash && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
...
const __TURBOPACK__default__export__ = SupplierDashboard;
}),

};

//# sourceMappingURL=%5Broot-of-the-server%5D__148dd46a._.js.map