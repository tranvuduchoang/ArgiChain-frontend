...
const MintNFTPageContent = ()=>{
    ...
    const handleMintNFT = async (e)=>{
        ...
        try {
            ...
            const contractAddress = mintParams.contractAddress || (("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : undefined) || __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$blockchain$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BLOCKCHAIN_CONFIG"].NFT_ADDRESS;
            const tokenId = mintParams.tokenId || 1;
            const quantity = parseInt(mintData.quantity.toString());
            // Call blockchain mint function
            const transactionHash = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$blockchain$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["mintNFT"])(contractAddress, account, tokenId, quantity);
...
//# sourceMappingURL=src_app_supplier_mint-nft_page_tsx_4d8f322b._.js.map